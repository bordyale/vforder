...
orderItemShippingItem = select("orderId","orderItemSeqId","quantity","quantityShipped","productId","productName").from("OrderItemShippingItemView").where("orderId", orderId).cache(false).queryList()
